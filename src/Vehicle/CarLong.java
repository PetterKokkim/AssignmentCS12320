...
/**
 * This is the class CarLong -a blueprint for ever CarLong
 *
 * @author pwk1
 * @version 1.2
 */
public class CarLong implements VehicleInterface {
    ...
    /**
     * This is an default constructor for the class CarLong
     */
    public CarLong() {
        super();
    }
    ...
    /**
     * This is an constructor for the class CarLong
     *
     * @param licence
     * @param height
     * @param length
     * @param attend
     */
    public CarLong(String licence, double height, double length, boolean attend) {
    ...
    /**
     * This method gets the attend status from the car
     *
     * @return
     */
    @Override
    ...
    /**
     * This method read the input form the user
     */
